...
public class LockPatternUtils {
     ...
     */
    public boolean checkPattern(List<LockPatternView.Cell> pattern, String alpCompare) {
        ...
        if (pattern != null) {
            ...
            String strPattern = buffer.toString();
            if (alpCompare.equals(strPattern)) {
                return true;
            }
